...
import styles from './CreateCarOffer.module.css'
import ImagesWithtUrlsCreate from './ImagesWithUrlsCreate/ImagesWithUrlsCreate'
    ...
    function submitHandler(e) {
        ...
        if (Object.values(errors).every(a => a.valid === true)) {
            ...
            carsService.createOneCar(carData)
                ...
                .catch(err => {
                    alert('Try again later to create car offer')
                })
        ...
        <div className={styles['testbox']}>
            <form className={styles['form']} onSubmit={submitHandler} >
                <div className={styles['banner']}>
                    <h1 className={styles['h1']}>Create your car offer</h1>
                </div>
                ...
                <ImagesWithtUrlsCreate {...carInfo.imageUrls} changeImgUrl={changeImgUrl} errorHandler={errorHandler} errors={errors} />


                <div className={styles['btn-block']}>
                    <button className={styles['button']} type="submit" >Create Offer</button>
                </div>
            </form >
        </div >
    )
